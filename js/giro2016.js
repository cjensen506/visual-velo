            ...
            d3.csv("Data/Giro2016Results.csv", 
                ...
                d3.csv("Data/Giro2016_Stage_Cartoon.csv", function(error, RawStages) {
...
/*
                    ...
                    */ 
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(9,0) rotate(-90," + xScale(9)+",50)")
                        .attr("y",50)
                        .attr("x",xScale(9))
                        .text("ITT");
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(9,0) rotate(-90," + xScale(15)+",50)")
                        .attr("y",50)
                        .attr("x",xScale(15))
                        .text("ITT");
