            ...
            var Hformat = d3.time.format("+ %Hh %M' %S''");
            ...
            d3.csv("Data/tdf2015clean.csv", 
                   function(d) {  //Function to parse rider info input
                       temptime=null;
                       if (d.Gap.length <2){
                            temptime= d3.time.format("%S").parse("0");
                       } else if (d.Gap.length <11){
                ...
                d3.csv("Data/Tdf2015stages_Trim.csv", function(error, RawStages) {
                ...
                //    $("#RiderDrop").chosen({max_selected_options: 2 });
                    ...
                    */ 
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(9,0) rotate(-90," + xScale(StageToDistance(1))+",50)")
                        .attr("y",50)
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("text-anchor","middle")
                        .attr("y",50)
                        .attr("x",xScale(StageToDistance(9)))
                        .attr("transform","rotate(-90," + xScale(StageToDistance(9))+",50)")
                        .text("TTT");
