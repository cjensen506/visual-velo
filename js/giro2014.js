            ...
            d3.csv("Data/Giro2014Results.csv", 
                ...
                d3.csv("Data/Giro2014_Stage_Cartoon.csv", function(error, RawStages) {
...
/*
                    ...
                    */ 
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(9,0) rotate(-90," + xScale(12)+",50)")
                        .attr("y",50)
                        .attr("x",xScale(12))
                        .text("ITT");
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(9,0) rotate(-90," + xScale(19)+",50)")
                        .attr("y",50)
                        .attr("x",xScale(19))
                        .text("ITT");
