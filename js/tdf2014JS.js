  ...
  //                  debugger;
            ...
            d3.csv("Data/TDF2014Results.csv", 
                ...
                d3.csv("Data/TDF2014_stagesTrim.csv", function(error, RawStages) {
             ...
             //       dropDownCountry.append("option").attr("value","");
                ...
                //    $("#RiderDrop").chosen({max_selected_options: 2 });
                    ...
                    */ 
                    ...
                    //Label TT stages time trial
                    ProfileSvg.append("text")
                        .style("font-family", "sans-serif")
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(0,0) rotate(-90," + xScale(StageToDistance(20))+",50)")
                        .attr("y",50)
                        .attr("x",xScale(StageToDistance(20)))
                        .text("ITT");
