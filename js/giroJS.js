  ...
  //                  debugger;
            ...
            d3.csv("Data/Giro2015Results.csv", 
                ...
                d3.csv("Data/GiroProfile2015_Trim.csv", function(error, RawStages) {
                ...
                //    $("#RiderDrop").chosen({max_selected_options: 2 });
                    ...
                    */ 
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("font-size", "16px")
                        .style("text-anchor","middle")
                        .attr("transform","translate(7,0) rotate(-90," + xScale(StageToDistance(1))+",50)")
                        .attr("y",50)
                    ...
                    ProfileSvg.append("text")
                        ...
                        .style("text-anchor","middle")
                        .attr("y",50)
                        .attr("x",xScale(StageToDistance(14)))
                        .attr("transform","rotate(-90," + xScale(StageToDistance(14))+",50)")
                        .text("ITT");
