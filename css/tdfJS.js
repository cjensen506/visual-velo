            ...
            //Zoom & pan bar
            var svgZoom = d3.select("#RiderGraph").append("svg")
                .attr("width", 20)
                .attr("height", h + Rmargin.top + Rmargin.bottom)
                    ...
                    */ 
                    ...
                    .attr("name", function(d) {
                        ...
                        .on('mouseover', function(d) {
                            ...
                            var xPosition = xScale(StageToDistance(currentStage)) + 30;
                            var yPosition = 0;
                    ...
                    svg.append("g")
                        ...
                        .attr("transform", "translate(-" + (Rmargin.left) + "," + ((h - Rmargin.top - Rmargin.bottom) / 2 + Rmargin.bottom) + ") rotate(-90)") //move label
                        .attr("dy", ".71em")
                        .style("text-anchor", "middle")
                ...
                if (currentDisplay == 0) { //by rank view
                    ...
                    if (! GConly) {
                       ...
                       yTimeScale.domain([yTimeScaleConstant.invert(yZoomScale(brush.extent()[0])),yTimeScaleConstant.invert(yZoomScale(brush.extent()[1]))]); 
                        ...
                        yTimeScale.domain([d3.time.format("%S").parse("0"), d3.time.format("%M").parse("20")]);
                    }
